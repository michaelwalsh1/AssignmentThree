...
public class PurpleBoxTestMain {
                    ...
                    while (movieFlag == false) {
                        ...
                        switch (userInput) {   //movie menu cases
                            ...
                            case 2:   //search by name
                                userInput = -1;
                                int searchedMovie = searchMovieByName(movieList);
                                ...
                                System.out.println("" + movieList.get(searchedMovie));
                                System.out.println("\n" + searchedMovie);
                                break;
    ...
    public static int searchMovieByName(ArrayList<Product> movieList) {
        //declare variables
        String userInput;
        ...
        for (int i = 0; i < movieList.size(); i++) {
            if (movieList.get(i).getName().equalsIgnoreCase(userInput)) {
                foundIndex = i;
                return foundIndex;
            } 
        }//end for loop
